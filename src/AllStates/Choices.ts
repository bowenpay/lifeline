...
class Choices {
    public static QUESTIONS = [
        {
            ...
            detail: [
                ...
                '那么，请先选择你想要从什么样起点开始创业。教育背景：',
                
            ],
            answers: [
                { answer: "国内/国际重点院校硕博",event: "教育背景1" },
                { answer: "国内/国际重点院校本专",event: "教育背景2" },
    ...
    public static EVENTS = [ //选择背景状态
        ...
        { detail: ['良好的家庭经济情况让你在创业路上能够承受更大的风险和失败'],name: '家庭经济富裕',from: '填写背景状态',to: '互联网行业初期状态',properties: { health: 100,wealth: 200000,ability: 0,fuyu: 1 } },
        { detail: ['良好的家庭经济情况让你在创业路上能够承受更大的风险和失败'],name: '家庭经济较富裕',from: '填写背景状态',to: '互联网行业初期状态',properties: { health: 100,wealth: 150000,ability: 0 } },
        { detail: ['一般的家庭经济情况让你在创业路上承受更大的风险和困难'],name: '家庭经济一般',from: '填写背景状态',to: '互联网行业初期状态',properties: { health: 100,wealth: 100000,ability: 0 } },
        { detail: ['一般的家庭经济情况让你在创业路上承受更大的风险和困难'],name: '家庭经济贫困',from: '填写背景状态',to: '互联网行业初期状态',properties: { health: 100,wealth: 50000,ability: 0 } },
    ];
